...
### AI briefs
Each barangay's brief (English + Tagalog) is generated by Claude from that
barangay's computed numbers only, then machine-validated: every number in the text
must exist in the input payload, otherwise the brief is regenerated or replaced by a
deterministic template. Model: claude-haiku-4-5, batch API.
""")
